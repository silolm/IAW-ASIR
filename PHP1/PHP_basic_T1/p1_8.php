...
<body>
    ...
    <table class="articulos">
        <tr>
            <th colspan="2" align="center">Precio de los artículos</th>
        </tr>
        <tr>
            <td>Frenos</td>
            <td>100</td>
    ...
    <table class="pedido">
        <tr>
            <th colspan="2" align="center">Pedido</th>
        </tr>
        <tr>
            <th>Descripción</th>
            <th>Cantidad</th>
        ...
        <tr>
            <td>Frenos</td>
            <td align="right"><?php echo $frenos; ?></td>
        </tr>
        <tr>
            <td>Aceite</td>
            <td align="right"><?php echo $aceite; ?></td>
        </tr>
        <tr>
            <td>Ruedas</td>
            <td align="right"><?php echo $ruedas; ?></td>
        </tr>
    </table>
