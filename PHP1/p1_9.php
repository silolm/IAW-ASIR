...
<head>
    ...
    <style type="text/css">
        .table  {border:none;border-collapse:collapse;border-color:#93a1a1;border-spacing:0;width: 50%;}
        .table td{background-color:#fdf6e3;border-color:#93a1a1;border-style:solid;border-width:0px;color:#002b36;
        font-family:Arial, sans-serif;font-size:14px;overflow:hidden;padding:10px 5px;word-break:normal;width: 25%}
        .table th{background-color:#657b83;border-color:#93a1a1;border-style:solid;border-width:0px;color:#fdf6e3;
        font-family:Arial, sans-serif;font-size:14px;font-weight:normal;overflow:hidden;padding:10px 5px;word-break:normal;}
        .table .fecha{font-family:"Courier New", Courier, monospace !important;;font-size:100%;text-align:right;vertical-align:middle}
        .table .titulo{font-family:"Courier New", Courier, monospace !important;;font-size:100%;font-style:italic;text-align:center;
        vertical-align:middle}
        .table .hora{font-family:"Courier New", Courier, monospace !important;;font-size:100%;text-align:left;vertical-align:middle}
        .table .darkRow{background-color:#eee8d5;font-family:"Courier New", Courier, monospace !important;;font-size:100%;text-align:center;
        vertical-align:middle}
        .table .lightRow{font-family:"Courier New", Courier, monospace !important;;font-size:100%;text-align:center;vertical-align:middle}
</style>
</head>
